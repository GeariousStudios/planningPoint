...
const ImportRulesClient = dynamic(() => import("./ImportRulesClient"), {
  ssr: false,
  loading: () => (
    <>
...
const ImportRulesWrapper = () => {
  ...
  return <ImportRulesClient isConnected={isConnected} />;
};

export default ImportRulesWrapper;
