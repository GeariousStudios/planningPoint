...
const PlanningRulesClient = dynamic(() => import("./PlanningRulesClient"), {
  ssr: false,
  loading: () => (
    <>
...
const PlanningRulesWrapper = () => {
  ...
  return <PlanningRulesClient isConnected={isConnected} />;
};

export default PlanningRulesWrapper;
