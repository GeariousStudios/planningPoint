...
const PlannedStopsClient = dynamic(() => import("./PlannedStopsClient"), {
  ssr: false,
  loading: () => (
    <>
...
const PlannedStopsWrapper = () => {
  ...
  return <PlannedStopsClient isConnected={isConnected} />;
};

export default PlannedStopsWrapper;
